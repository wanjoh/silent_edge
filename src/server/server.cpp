...
void GameServer::initializeTimers()
{
    ...
    connect(logic_handler_, &GameLogicHandler::updateBulletsSignal, this, &GameServer::updateBulletsSignal);
...
void GameServer::updateBulletsSignal(const QByteArray& bullet_info)
{
